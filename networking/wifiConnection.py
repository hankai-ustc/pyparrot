...
class WifiConnection:
    ...
    def _listen_socket(self):
        ...
        while (self.is_listening):
            try:
                data, address = self.udp_receive_sock.recvfrom(2048)
    ...
    def _handshake(self, num_retries):
        ...
        # connect
        tcp_sock.connect((self.drone_ip, self.drone_listen_port))
    ...
    def _create_udp_connection(self):
        ...
        self.udp_receive_sock.bind(('192.168.48.15', 43210))
...
# in the same way the send_enum_command_packet_ack does. 
    ...
    def send_fly_command(self,command_tuple,roll,pitch,yaw,vertical_movement):
        """
        :param commanf_tuple:
        :param roll:
        :param pitch:
