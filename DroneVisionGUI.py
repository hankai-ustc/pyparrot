...
class DroneVisionGUI:
    def __init__(self, drone_object, is_bebop, user_code_to_run, user_args, buffer_size=10, network_caching=50):
        """
    ...
    def safe_takeoff(self):
        self.drone_object.safe_takeoff(2)
    ...
    def open_video(self):
        ...
        print(str(self.network_caching))
